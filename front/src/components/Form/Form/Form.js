...
class Form extends Component {
  ...
  transform = (value) =>
    typeof parseInt(value, 10) === "number" && value <= 9
      ? `0${value <= 0 ? 1 : value}`
      : value.replace(/[ ]/g, "-");
  ...
  render() {
    return (
      <div>
        ...
        <div className="form-group">
          <label htmlFor="season" className="label-form">
            Saison
          </label>
          <input
            type="number"
        ...
        <div className="form-group">
          <label htmlFor="episode" className="label-form">
            Épisode
          </label>
          <input
            type="number"
        ...
        <div className="form-group">
          <label htmlFor="grade" className="label-form">
            Note
          </label>
          <input
            type="number"
        ...
        <button id="watched" className="btn btn-primary">
          Watched
        </button>
        <button id="update" className="disabled btn btn-primary">
          Update
        </button>
      </div>
    );
  ...
  onClick(consumer) {
    ...
    consumer.actions.add({
      name: serie,
      grade: grade,
      episode: episode,
      code: `S${this.transform(season)}E${this.transform(episode)}`,
    });
  }
}
